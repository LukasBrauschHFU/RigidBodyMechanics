...
//
//public class ColllisionTransformation {
//	private double k = 1;
...
//	private Vector2D r;
//
//	public ColllisionTransformation(RigidBody r1, RigidBody r2, Impactpoint ip) {
//		this.rb1 = r1;
//		this.rb2 = r2;
//		this.ip = ip;
//	}
//
//	public ColllisionTransformation(Ball ball, Incline il) {
//		this.il = il;
//		this.r = ball.r;
//		this.ip = ip;
//	}
...
////Transformation
//		// 1. r -p
//		Vector2D rm = VectorMath.sub(ball.r, p);
//
//
//		double rot = VectorMath.angle(new Vector2D(0, 1), il.alpha);
//
